...
function renderCases(items: Array<{ generation: Generation; testCase: Generation["testCases"][number] }>) {
  return `<table>
    <thead><tr><th>ID</th><th>Work Item Type</th><th>Title</th><th>Test Step</th><th>Step Action</th><th>Step Expected</th><th>Area Path</th><th>Assigned To</th><th>State</th></tr></thead>
